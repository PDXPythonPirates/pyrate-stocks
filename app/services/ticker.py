...
from app.main.forms import LoginForm, UpdateForm, SignUpForm, LogoutForm
...
class Ticker:
    ...
    #NOTE: DASHBOARD DATA DOES NOT RENDER
    def dashboard():
        if current_user.is_authenticated:
            ...
            return render_template('dashboard.html', loform=LogoutForm(), uform=UpdateForm())
        else:
